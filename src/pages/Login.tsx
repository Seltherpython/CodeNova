  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center space-y-4">
        <SEO title="Secure Login | Repodata AI - Access Your Code Analysis Portal" description="Sign in to Repodata AI to manage your GitHub repositories and access advanced code reasoning tools. Securely connect using your Google or GitHub account." />
